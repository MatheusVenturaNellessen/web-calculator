...
<p>Esse projeto é uma calculadora web desenvolvida em HTML, CSS e JavaScript. A calculadora realiza cálculos matemáticos básicos via entrada de dadaos pelo usuário.</p>
...
<pre>
    ...
    │   │   └── main.js         
    │   └── img/                    # Imagens utilizadas na calculadora
    │       └── delete-icon.png 
    │
    └── index.html                  # Página principal da calculadora</pre>
